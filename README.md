# Multiagent_MCP_Databricksapp
Demo of a Streamlit-based Databricks App where executives can chat with an AI agent that orchestrates 3 managed MCP servers (Genie + UC Functions + Vector Search) for data quality insights.
